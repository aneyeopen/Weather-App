...
export const UI = (() => {
    ...
    function changeIcons(mainCondition, dayPlusOneCondition, dayPlusTwoCondition, localDate) {
        ...
        displayLogic.icon.src = `https://aneyeopen.github.io/Weather-App/src/Resources/Icons/WeatherIcons/${mainCondVar}.svg`;
        if (isDay(localDate)) {
            ...
            if(mainCondVar == "cloudy"){
                ...
                displayLogic.form.style.background = `url(https://aneyeopen.github.io/Weather-App/src/Resources/Backgrounds/rain.gif`;
            } else{
                displayLogic.form.style.background = `url(https://aneyeopen.github.io/Weather-App/src/Resources/Backgrounds/${mainCondVar}.gif`;
        ...
        if (dayOneCondVar == "night"){
            displayLogic.forecastDayPlusOneIcon.src = `https://aneyeopen.github.io/Weather-App/src/Resources/Icons/WeatherIcons/sunny.svg`;
        } else {
            displayLogic.forecastDayPlusOneIcon.src = `https://aneyeopen.github.io/Weather-App/src/Resources/Icons/WeatherIcons/${dayOneCondVar}.svg`;
        }
        ...
        if (dayTwoCondVar == "night"){
            displayLogic.forecastDayPlusTwoIcon.src = `https://aneyeopen.github.io/Weather-App/src/Resources/Icons/WeatherIcons/sunny.svg`;
        } else {
            displayLogic.forecastDayPlusTwoIcon.src = `https://aneyeopen.github.io/Weather-App/src/Resources/Icons/WeatherIcons/${dayTwoCondVar}.svg`;
        }
